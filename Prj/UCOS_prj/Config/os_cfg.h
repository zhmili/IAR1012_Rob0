...
#define OS_MAX_EVENTS            12    /* Max. number of event control blocks in your application      */
...
#define OS_TICKS_PER_SEC       1000    /* Set the number of ticks in one second                        */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE     32    /* Timer      task stack size (# of OS_STK wide entries)        */
...
#define OS_TMR_CFG_NAME_SIZE      20    /*     Determine the size of a timer name                       */
